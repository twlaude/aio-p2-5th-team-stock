...
def test_fgi_success_maps_latest_index():
    upstream = {"stock_code": "005930", "fgi": 64.2, "label": "탐욕", "post_count": 82, "summary": "매수 기대가 우세하다.", "as_of": "2026-09-02T09:15:00Z", "warnings": ["표본 부족 가능성"], "source_name": "커뮤니티 FGI 서버(네이버 종목토론실)"}
